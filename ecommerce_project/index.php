    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" id="loginF" action="php/login.php" method="post">
            <div class="form-group">
              <input type="email" class="form-control" id="email" name="email" placeholder="Email" required>
              
              <div id="email_validate" class="alert alert-danger alert-common alert-dismissible" role="alert" hidden>
            ...
            <div class="form-group">
              ...
              <div id="password_validate" class="alert alert-danger alert-common alert-dismissible" role="alert" hidden>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
